   ...
   <Container >
    ...
    <Row className=" d-flex justify-content-center align-items-center mt-5" >
     <Col className=" col-8  offset-1" >
      <h5> اسم من مازیارِ و کار من این روزها 
      ...
      <p className="mt-4">برنامه نویسی رو سال 1394 با یادگیری JAVA شروع کردم و بعد از مدتی به دلیل علاقه‌‌‌ ‌‌‌‌م 
